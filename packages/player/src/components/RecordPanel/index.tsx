...
export const RecordPanel = () => {
    ...
    const [recordPanelOpened, setRecordPanelOpened] = useAtom(recordPanelOpenedAtom);
    ...
    return (<AnimatePresence>
        <div className={styles.recordPanelContainer}>
            {recordPanelOpened && mediaStream && <motion.div className={styles.recordPanel} layout initial={{
                transform: "scale(0.8)",
                opacity: 0,
            }} animate={{
                transform: "scale(1)",
                ...
                <button type="button" onClick={() => {
                    ...
                    const recorder = new MediaRecorder(mediaStream, { videoBitsPerSecond: 20000000, mimeType: "video/mp4" });
                ...
                }} style={mediaRecorder === undefined ? {
                } : {
                    backgroundColor: "var(--red-9)",
                }}>
                    {mediaRecorder === undefined && <span style={{
                        width: "1em",
                        height: "1em",
                        borderRadius: "50%",
                        backgroundColor: "var(--red-9)",
